...
* The function has to take one OWNSTATUS type parameter.
* OWNSTATUS is a struct defined in the header file.
...
void SwitchMatrix::AddEventListener(void(*listener)(OWNSTATUS))
{
